      ...
      >
        <div className="flex flex-col justify-center items-center h-full mb-60 ml-2 ">
          ...
          <Link href="/home">
            ...
            <div
              className={`flex mb-2 justify-start items-center gap-6 pl-5 hover:bg-sky-500 hover:text-white p-3  group cursor-pointer md:pl-0 ${
                activePage === "notifications" ? "bg-sky-500 text-white" : ""
              }`}
              onClick={() => handlePageClick("notification")}
            >
              <BsFillBellFill className="text-2xl fill-white ml-5" />
              
              <h3 className="w-28 h-6 text-xl font-normal font-['Sanchez'] text-white">
                Notifications
              </h3>
            ...
            {/* <div
              className={`flex mb-2 justify-start items-center gap-6 pl-5 hover:bg-sky-500 hover:text-white p-3  group cursor-pointer  md:pl-0 ${
                activePage === "profile" ? "bg-sky-500 text-white" : ""
              }`}
              onClick={() => handlePageClick("profile")}
            >
              <RiAccountCircleFill className="text-2xl fill-white ml-5" />
              <h3 className="w-28 h-6 text-xl font-normal font-['Sanchez'] text-white">
                Profile
              </h3>
            </div> */}
